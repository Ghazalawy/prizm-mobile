...
/**
 * Dashboard. The welcome/profile card used to live here, but the top bar
 * now shows the avatar (and Settings has the full profile hero), so the
 * card was duplicative — it ate vertical space without adding signal.
 */

...
export const MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    defaultSort: { field: "opportunity_id", direction: "desc" },
    filterableFields: ["stage", "status", "partner_id", "estimated_price"],
    statusField: "stage",
    ...
    actions: [
      ...
      },
      {
        ...
        method: "POST",
        fields: [
          { key: "statusID", label: "Status ID", type: "number", required: true },

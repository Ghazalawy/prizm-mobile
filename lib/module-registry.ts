...
export const MODULES: ModuleDefinition[] = [
  ...
  {
    key: "purchase_supplier_invoices",
    title: "Supplier Invoice",
    plural: "Supplier Invoices",
    group: "Purchase",
    endpoint: "purchase_api/supplier_invoices",
    permissionFeature: "supplier_invoice",
    idKey: "id",
    icon: "receipt-outline",
    color: "#EA580C",
    titleFields: ["display_number", "sequence_number", "supplier_invoice_number", "id"],
    subtitleFields: ["supplier_name", "supplier_invoice_number", "status", "payment_status", "due_date", "grand_total"],
    searchFields: ["display_number", "supplier_invoice_number", "supplier_name", "project_name", "po_title", "notes"],
    defaultSort: { field: "id", direction: "desc" },
    sortableFields: ["id", "sequence_number", "supplier_invoice_number", "supplier_name", "invoice_date", "due_date", "grand_total", "status", "payment_status"],
    filterableFields: ["sequence_number", "supplier_invoice_number", "supplier_id", "supplier_name", "invoice_date", "due_date", "po_id", "project_id", "department_id", "cost_center", "currency_id", "subtotal", "vat_amount", "grand_total", "status", "payment_status", "requested_date"],
    statusField: "status",
    statusOptions: [
      { label: "Draft", value: "Draft", color: "#64748B" },
      ...
      { label: "Approved", value: "Approved", color: "#16A34A" },
      { label: "Rejected", value: "Rejected", color: "#DC2626" },
      { label: "Cancelled", value: "Cancelled", color: "#78716C" },
    ],
    supportsAdvancedFilters: true,
    filterRules: {
      ...
      department_id: { ruleType: "MultiSelectRule" },
      currency_id: { ruleType: "MultiSelectRule" },
      status: { ruleType: "MultiSelectRule" },
      payment_status: { ruleType: "MultiSelectRule" },
    },
    detailRootKey: "invoice",
    fields: [
      { key: "supplier_id", label: "Supplier", section: "Invoice", type: "number", required: true, customEditor: true },
      { key: "supplier_invoice_number", label: "Supplier Invoice No.", section: "Invoice", required: true, customEditor: true },
      { key: "invoice_date", label: "Invoice Date", section: "Dates", type: "date", customEditor: true },
      { key: "due_date", label: "Due Date", section: "Dates", type: "date", customEditor: true },
      { key: "po_id", label: "Purchase Order", section: "Context", type: "number", customEditor: true },
      { key: "project_id", label: "Project", section: "Context", type: "number", customEditor: true },
      { key: "department_id", label: "Department", section: "Context", type: "number", required: true, customEditor: true },
      { key: "cost_center", label: "Cost Center", section: "Context", customEditor: true },
      { key: "currency_id", label: "Currency", section: "Amounts", type: "number", customEditor: true },
      { key: "subtotal", label: "Subtotal", section: "Amounts", type: "money", customEditor: true },
      { key: "vat_amount", label: "VAT", section: "Amounts", type: "money", customEditor: true },
      { key: "grand_total", label: "Grand Total", section: "Amounts", type: "money", customEditor: true },
      { key: "notes", label: "Supplier Notes", section: "Notes", type: "multiline", customEditor: true },
      { key: "internal_remarks", label: "Internal Remarks", section: "Notes", type: "multiline", customEditor: true },
      { key: "items", label: "Invoice Lines", section: "Lines", type: "json", defaultValue: "[]", customEditor: true },
      { key: "status", label: "Workflow Status", section: "Workflow", type: "select", readOnly: true, options: [
        { label: "Draft", value: "Draft" }, { label: "Submitted", value: "Submitted" },
        { label: "Approved", value: "Approved" }, { label: "Rejected", value: "Rejected" },
        { label: "Cancelled", value: "Cancelled" },
      ] },
      { key: "payment_status", label: "Payment Status", section: "Workflow", type: "select", readOnly: true, options: [
        { label: "Unpaid", value: "Unpaid" }, { label: "Paid", value: "Paid" },
      ] },
      { key: "requested_date", label: "Created", section: "Workflow", type: "datetime", readOnly: true },
    ],
    tabs: [
      { key: "files", title: "Files", moduleKey: "files", kind: "files", fixedFilters: { rel_type: "supplier_invoice" } },
    ],
    actions: [
      { key: "submit", title: "Submit for Approval", icon: "paper-plane-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/submit", confirm: "Submit this supplier invoice into its configured approval workflow?", successMessage: "Submitted for approval" },
      { key: "approve", title: "Approve Current Stage", icon: "checkmark-circle-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/approve", fields: [{ key: "note", label: "Approval note", type: "multiline" }], confirm: "Approve the current workflow stage?", successMessage: "Approval recorded" },
      { key: "reject", title: "Reject Current Stage", icon: "close-circle-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/reject", fields: [{ key: "note", label: "Rejection reason", type: "multiline", required: true }], confirm: "Reject the current workflow stage?", successMessage: "Invoice rejected", destructive: true },
      { key: "cancel", title: "Cancel Invoice", icon: "ban-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/cancel", fields: [{ key: "note", label: "Cancellation note", type: "multiline" }], confirm: "Cancel this supplier invoice?", successMessage: "Invoice cancelled", destructive: true },
      { key: "reopen", title: "Reopen as Draft", icon: "refresh-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/reopen", confirm: "Reopen this invoice as an editable draft?", successMessage: "Invoice reopened" },
      { key: "mark_paid", title: "Mark Paid", icon: "cash-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/mark_paid", confirm: "Mark this approved supplier invoice as paid?", successMessage: "Marked paid" },
      { key: "undo_paid", title: "Undo Paid", icon: "return-down-back-outline", endpointTemplate: "purchase_api/supplier_invoices/{id}/undo_paid", confirm: "Return this supplier invoice to unpaid?", successMessage: "Payment status reverted" },
    ],
  },
  {
  ...
  {
    key: "gatepass_requests",
    title: "Gate Pass Request",
    plural: "Gate Pass Requests",
    group: "Operations",
    endpoint: "gatepass_api/requests",
    permissionFeature: "gatepass_RequestManager",
    idKey: "id",
    icon: "clipboard-outline",
    color: "#0F766E",
    titleFields: ["display_number"],
    subtitleFields: ["request_classification", "related_name", "requester_name", "duration_to", "is_converted"],
    searchFields: ["display_number", "po_number", "request_classification", "related_name", "requester_name", "representative_name", "work_location", "work_details", "stations", "substation"],
    defaultSort: { field: "id", direction: "desc" },
    sortableFields: ["id", "created_at", "request_classification", "requester_name", "rel_type", "duration", "duration_from", "duration_to", "status", "is_converted"],
    filterableFields: ["id", "created_at", "request_classification", "requester", "rel_type", "rel_id", "duration", "duration_from", "duration_to", "work_location", "work_details", "stations", "substation", "representative_id", "po_number", "status", "is_converted"],
    statusField: "status",
    statusOptions: [
      { label: "Active", value: 1, color: "#16A34A" },
      { label: "Expired", value: 0, color: "#64748B" },
    ],
    filterRules: {
      request_classification: { ruleType: "MultiSelectRule" },
      requester: { ruleType: "MultiSelectRule" },
      rel_type: { ruleType: "MultiSelectRule" },
    ...
    fields: [
      ...
      { key: "rel_type", label: "Related Type", section: "Relation", type: "select", required: true, customEditor: true, options: [{ label: "Project", value: "project" }, { label: "Opportunity", value: "opportunity" }] },
      { key: "rel_id", label: "Related Record", section: "Relation", type: "number", required: true, customEditor: true },
      { key: "duration", label: "Duration Type", section: "Validity", type: "select", required: true, customEditor: true, options: [{ label: "Short Term Entry Pass", value: "Short Term Entry Pass" }, { label: "Long Term Entry Pass", value: "Long Term Entry Pass" }, { label: "One Day Entry Pass", value: "One Day Entry Pass" }] },
      { key: "duration_from", label: "Valid From", section: "Validity", type: "date", required: true, customEditor: true },
      { key: "duration_to", label: "Valid Until", section: "Validity", type: "date", required: true, customEditor: true },
      { key: "po_number", label: "RFX / PO Number", section: "Work", customEditor: true },
      { key: "work_location", label: "Work Location", section: "Work", customEditor: true },
      { key: "stations", label: "Stations", section: "Work", customEditor: true },
      { key: "substation", label: "Substations", section: "Work", customEditor: true },
      { key: "work_details", label: "Work Details", section: "Work", type: "multiline", customEditor: true },
      { key: "representative_id", label: "Representative", section: "People", relation: "staff", customEditor: true },
      { key: "staff_id", label: "People Involved", section: "People", relation: "staff", multiple: true, submitAsArray: true, customEditor: true },
      { key: "vehicle_id", label: "Vehicles", section: "People", relation: "gatepass_vehicle", multiple: true, submitAsArray: true, customEditor: true },
      { key: "display_number", label: "Request Number", section: "System", readOnly: true },
      { key: "requester_name", label: "Requested By", section: "System", readOnly: true },
      { key: "related_name", label: "Related Record", section: "System", readOnly: true },
      { key: "status", label: "Status", section: "System", type: "boolean", readOnly: true },
      { key: "is_converted", label: "Converted", section: "System", type: "boolean", readOnly: true },
      { key: "gatepass_id", label: "Gate Pass ID", section: "System", type: "number", readOnly: true },
      { key: "created_at", label: "Created", section: "System", type: "datetime", readOnly: true },
    ],
    actions: [
      { key: "convert", title: "Convert to Gate Pass", icon: "arrow-forward-circle-outline", endpointTemplate: "gatepass_api/requests/{id}/convert", confirm: "Create a Gate Pass from this approved request data?", successMessage: "Gate Pass created" },
    ],
  },
  {
    key: "gatepass",
...
> = {
  ...
  gatepass_requests: {
    request_classification: "MultiSelectRule",
    requester: "MultiSelectRule",
    rel_type: "MultiSelectRule",
    duration: "MultiSelectRule",
    representative_id: "MultiSelectRule",
    status: "CheckboxRule",
